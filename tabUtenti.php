...
if ((isset($_SERVER['QUERY_STRING4'])) && ($_SERVER['QUERY_STRING4'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING4']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username4'] = NULL;
  $_SESSION['MM_UserGroup4'] = NULL;
  $_SESSION['PrevUrl4'] = NULL;
  unset($_SESSION['MM_Username4']);
  unset($_SESSION['MM_UserGroup4']);
  unset($_SESSION['PrevUrl4']);
...
if (!((isset($_SESSION['MM_Username'])) && (isAuthorized('',$MM_authorizedUsers, $_SESSION['MM_Username'], $_SESSION['MM_UserGroup'])))) {   
  ...
  if (isset($_SERVER['QUERY_STRING4']) && strlen($_SERVER['QUERY_STRING4']) > 0) 
  $MM_referrer .= '?' . $_SERVER['QUERY_STRING4'];
