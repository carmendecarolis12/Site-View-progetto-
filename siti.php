...
if ((isset($_SERVER['QUERY_STRING11'])) && ($_SERVER['QUERY_STRING11'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING11']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username11'] = NULL;
  $_SESSION['MM_UserGroup11'] = NULL;
  $_SESSION['PrevUrl11'] = NULL;
  unset($_SESSION['MM_Username11']);
  unset($_SESSION['MM_UserGroup11']);
  unset($_SESSION['PrevUrl11']);
...
$totalPages_Recordset1 = ceil($totalRows_Recordset1/$maxRows_Recordset1)-1;$maxRows_Recordset1 = 10;$pageNum_Recordset1 = 0;
if (isset($_GET['pageNum_Recordset1'])) {
  $pageNum_Recordset1 = $_GET['pageNum_Recordset1'];
}
$startRow_Recordset1 = $pageNum_Recordset1 * $maxRows_Recordset1;

$MM_Username_Recordset1 = '-1';
if (isset($_SESSION['MM_Username'])) {
  $MM_Username_Recordset1 = sprintf('MM_Username');
}
mysql_select_db($database_dbConnect, $dbConnect);
...
<?php endif; ?>
			...
			<!-- Main -->
				<article id="main">
				  <header>
				    <h2>SELEZIONA UN SITO</h2>
                    <p>Seleziona il sito di cui vuoi visualizzare le rilevazioni e clicca rispettivamente su "visualizza".</p>
				  </header>
			    </article>
...
<td></div>
<font color="#ED4933">
<a href="visualizzaRilevazioni.php">VISUALIZZA</a></td>
          </tr>
