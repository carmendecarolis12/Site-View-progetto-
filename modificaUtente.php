...
if ((isset($_SERVER['QUERY_STRING20'])) && ($_SERVER['QUERY_STRING20'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING20']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username20'] = NULL;
  $_SESSION['MM_UserGroup20'] = NULL;
  $_SESSION['PrevUrl20'] = NULL;
  unset($_SESSION['MM_Username20']);
  unset($_SESSION['MM_UserGroup20']);
  unset($_SESSION['PrevUrl20']);
...
if ((isset($_POST['MM_update'])) && ($_POST['MM_update'] == 'form1')) {
  $updateSQL = sprintf('UPDATE utenti SET NOME=%s, COGNOME=%s, SESSO=%s, `DATA DI NASCITA`=%s, `INDIRIZZO DI RESIDENZA`=%s, `CITTA DI RESIDENZA`=%s, PROVINCIA=%s, `CODICE POSTALE`=%s, TELEFONO=%s, EMAIL=%s, USERNAME=%s, PASSWORD=%s, TIPO=%s WHERE ID=%s',
                       sprintf('NOME', 'text'),
    ...
    <p>Inserire i dati nei campi da modificare</p></div>
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <table align="center">
                ...
                <tr valign="baseline">
                  <td nowrap align="right">CITTA' DI RESIDENZA:</td>
                ...
                <tr valign="baseline">
                  <td nowrap align="right">CODICE POSTALE:</td>
