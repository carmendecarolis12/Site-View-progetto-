...
if ((isset($_SERVER['QUERY_STRING19'])) && ($_SERVER['QUERY_STRING19'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING19']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username19'] = NULL;
  $_SESSION['MM_UserGroup19'] = NULL;
  $_SESSION['PrevUrl19'] = NULL;
  unset($_SESSION['MM_Username19']);
  unset($_SESSION['MM_UserGroup19']);
  unset($_SESSION['PrevUrl19']);
...
if (!((isset($_SESSION['MM_Username'])) && (isAuthorized('',$MM_authorizedUsers, $_SESSION['MM_Username'], $_SESSION['MM_UserGroup'])))) {   
  ...
  if (isset($_SERVER['QUERY_STRING19']) && strlen($_SERVER['QUERY_STRING19']) > 0) 
  $MM_referrer .= '?' . $_SERVER['QUERY_STRING19'];
...
if ((isset($_POST['MM_update'])) && ($_POST['MM_update'] == 'form1')) {
  $updateSQL = sprintf('UPDATE siti SET NOME=%s, UBICAZIONE=%s, CITTA=%s, DESCRIZIONE=%s WHERE ID=%s',
                       sprintf('NOME', 'text'),
...
mysql_select_db($database_dbConnect, $dbConnect);
$query_Recordset1 = sprintf('SELECT * FROM siti WHERE ID = %s', GetSQLValueString($colname_Recordset1, 'int'));
			      ...
			      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
			        <table align="center">
			          ...
			          <tr valign="baseline">
			            ...
			            <td><input type="text" name="UBICAZIONE" value="<?php echo htmlentities($row_Recordset1['UBICAZIONE'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
		              </tr>
			          <tr valign="baseline">
			            <td nowrap align="right">CITTA':</td>
			            <td><input type="text" name="CITTA" value="<?php echo htmlentities($row_Recordset1['CITTA'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
		              </tr>
			          <tr valign="baseline">
			            <td nowrap align="right">DESCRIZIONE:</td>
			            <td><input type="text" name="DESCRIZIONE" value="<?php echo htmlentities($row_Recordset1['DESCRIZIONE'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
		              </tr>
			          <tr valign="baseline">
