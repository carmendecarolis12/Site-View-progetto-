...
if ((isset($_SERVER['QUERY_STRING1'])) && ($_SERVER['QUERY_STRING1'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING1']);
}
...
<table><thead>
    ...
    <tr>
		...
		echo htmlspecialchars($MARCA); ?></td>
        <td><?php 
		$TIPO = $row_Recordset1['TIPO'];
		echo htmlspecialchars($TIPO); ?></td>
        <td><?php 
		$VALOREMIN = $row_Recordset1['VAL_MIN'];
		echo htmlspecialchars($VALOREMIN); ?></td>
        <td><?php 
		$VALOREMAX = $row_Recordset1['VAL_MAX'];
		echo htmlspecialchars($VALOREMAX); ?></td>
        <td><?php 
		$COORDINATE = $row_Recordset1['COORDINATE'];
		echo htmlspecialchars($COORDINATE); ?></td>
      	<td><?php 
		$IDSITO = $row_Recordset1['IDsito'];
		echo htmlspecialchars($IDSITO); ?></td>
