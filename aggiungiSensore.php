...
if (!((isset($_SESSION['MM_Username'])) && (isAuthorized('',$MM_authorizedUsers, $_SESSION['MM_Username'], $_SESSION['MM_UserGroup'])))) {   
  ...
  if (isset($_SERVER['QUERY_STRING30']) && strlen($_SERVER['QUERY_STRING30']) > 0) 
  $MM_referrer .= '?' . $_SERVER['QUERY_STRING30'];
...
if ((isset($_POST['MM_insert'])) && ($_POST['MM_insert'] == 'form1')) {
  $insertSQL = sprintf('INSERT INTO sensori (MARCA, TIPO, VAL_MIN, VAL_MAX, COORDINATE) VALUES (%s, %s, %s, %s, %s)',
                       sprintf('MARCA', 'text'),
                       sprintf('TIPO', 'text'),
                       sprintf('VAL_MIN', 'int'),
                       sprintf('VAL_MAX', 'int'),
  ...
  $insertGoTo = 'GestisciSensori.php';
  if (isset($_SERVER['QUERY_STRING'])) {
...
<html>
	<head>
		<title>aggiungi un sensore</title>
		<meta charset="utf-8" />
...
<?php endif; ?>
				...
				<!-- Main -->
					<article id="main">
						<header>
						  <h2>aggiungi un sensore</h2>
						</header>
	<section class="wrapper style5">
							<div class="align-center">
	  <p>Inserire i dati del nuovo sensore (tutti i campi sono obbligatori).</p>
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="VAL_MIN" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">VALORE MAX:</td>
            <td><input type="text" name="VAL_MAX" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">COORDINATE:</td>
            <td><input type="text" name="COORDINATE" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
