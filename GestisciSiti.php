...
if ((isset($_SERVER['QUERY_STRING21'])) && ($_SERVER['QUERY_STRING21'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING21']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username21'] = NULL;
  $_SESSION['MM_UserGroup21'] = NULL;
  $_SESSION['PrevUrl21'] = NULL;
  unset($_SESSION['MM_Username21']);
  unset($_SESSION['MM_UserGroup21']);
  unset($_SESSION['PrevUrl21']);
...
if (!((isset($_SESSION['MM_Username'])) && (isAuthorized('',$MM_authorizedUsers, $_SESSION['MM_Username'], $_SESSION['MM_UserGroup'])))) {   
  $MM_qsChar = '?';
  $MM_referrer = $_SERVER['PHP_SELF1'];
  if (strpos($MM_restrictGoTo, '?')) $MM_qsChar = '&';
  if (isset($_SERVER['QUERY_STRING1']) && strlen($_SERVER['QUERY_STRING1']) > 0) 
  $MM_referrer .= '?' . $_SERVER['QUERY_STRING1'];
...
mysql_select_db($database_dbConnect, $dbConnect);
$query_Recordset1 = 'SELECT * FROM siti';
$query_limit_Recordset1 = sprintf('%s LIMIT %d, %d', $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $dbConnect);
if(!$Recordset1) {
...
<table><thead>
    <tr>
      ...
      <th><b><font color="#FFBF18">IDutente</th></b></font>
      <th></th>
      <th></th>
      <th></th>
    </tr></thead>
...
<font color="#ED4933">
<a href="assegnaSitoUtente.php?ID=<?php echo $row_Recordset1['ID']; ?>">ASSEGNA AD UN UTENTE</a></td>
</font>
</form>
       <form id="modifica"></div>
         <td><font color="#ED4933">
         <a href="modificaSito.php?ID=<?php echo $row_Recordset1['ID']; ?>">MODIFICA</a>
         </font></form>
        </td>
        <td> <font color="#ED4933"><a href="eliminaSito.php?ID=<?php echo $row_Recordset1['ID']; ?>">ELIMINA</a></font></td>
        
          </tr>
          <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
        <form id="add"></div><a class="button special" href="aggiungiSito.php?id=<?php echo $row_Recordset1['ID']; ?>">AGGIUNGI</a>
        </form>
  </tbody>
</table>
<div class=align-center>
