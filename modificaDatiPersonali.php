...
if ((isset($_SERVER['QUERY_STRING10'])) && ($_SERVER['QUERY_STRING10'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING10']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username10'] = NULL;
  $_SESSION['MM_UserGroup10'] = NULL;
  $_SESSION['PrevUrl10'] = NULL;
  unset($_SESSION['MM_Username10']);
  unset($_SESSION['MM_UserGroup10']);
  unset($_SESSION['PrevUrl10']);
...
if (!((isset($_SESSION['MM_Username'])) && (isAuthorized('',$MM_authorizedUsers, $_SESSION['MM_Username'], $_SESSION['MM_UserGroup'])))) {   
  ...
  if (isset($_SERVER['QUERY_STRING10']) && strlen($_SERVER['QUERY_STRING10']) > 0) 
  $MM_referrer .= '?' . $_SERVER['QUERY_STRING10'];
