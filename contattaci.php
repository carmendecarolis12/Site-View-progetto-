				...
				<!-- Main -->
					<article id="main">
						...
						<section class="wrapper style5">
							<div class="align-center">
							  <p>Compila il modulo, risponderemo il più presto possibile. Grazie.</p>
							  <hr />
							  <div class="row uniform">
											<div class="6u 12u$(xsmall)">
												<input type="text" name="demo-name" id="demo-name" value="" placeholder="Nome e cognome" required/>
											</div>
											<div class="6u$ 12u$(xsmall)">
											...
											<div class="12u$">
												<ul class="actions">
													<li><input type="submit" class="special" onClick="MM_popupMsg('Messaggio inviato con successo!')" value="Invia" /></li>
											  </ul>
											</div>
							  </div>
</div>
