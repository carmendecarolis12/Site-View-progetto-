...
if ((isset($_SERVER['QUERY_STRING22'])) && ($_SERVER['QUERY_STRING22'] != '')){
  $logoutAction .='&'. htmlentities($_SERVER['QUERY_STRING22']);
}

if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=='true')){
  //to fully log out a visitor we need to clear the session varialbles
  $_SESSION['MM_Username22'] = NULL;
  $_SESSION['MM_UserGroup22'] = NULL;
  $_SESSION['PrevUrl22'] = NULL;
  unset($_SESSION['MM_Username22']);
  unset($_SESSION['MM_UserGroup22']);
  unset($_SESSION['PrevUrl22']);
